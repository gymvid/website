    ...
    <>
      ...
      <div className={`fixed inset-x-0 bottom-0 md:inset-0 md:flex md:items-center md:justify-center z-50 transition-all duration-300 ease-out ${
        ...
        <div className="bg-white rounded-t-xl md:rounded-xl shadow-xl max-w-2xl mx-auto md:w-full md:mx-4">
          ...
          <button
            onClick={handleClose}
            className="absolute top-4 right-4 p-2 hover:bg-gray-light rounded-full transition-colors md:hidden"
            aria-label="Close"
          >
            <X className="w-5 h-5 text-gray-dark" />
          </button>

          {/* Back Button - Mobile only, show on step 2 and 3 */}
          {(step === 2 || step === 3) && !isSuccess && (
            <button
              onClick={handleBack}
              className="absolute top-4 left-4 p-2 hover:bg-gray-light rounded-full transition-colors md:hidden"
              aria-label="Back"
            >
          ...
          <div className="px-6 pb-8 pt-5 relative">
            ...
            {/* Desktop Back Button - Only show on step 2 and 3 */}
            {(step === 2 || step === 3) && !isSuccess && (
              <button
                onClick={handleBack}
                  ...
                  <>
                    <div className="text-center mb-5 pt-2">
                      ...
                      <div className="text-base text-gray-medium leading-relaxed space-y-3">
                        ...
                        <p className="text-primary">We're building the worlds first AI that can...</p>
                        <ul className="text-center space-y-2">
                          <li className="flex items-center justify-center gap-2">
                            <svg className="w-5 h-5 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                            </svg>
                            <span>Auto-Log Your Exercises, Reps, & Weights</span>
                          </li>
                          <li className="flex items-center justify-center gap-2">
                            <svg className="w-5 h-5 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                            </svg>
                            <span>Analyse Your Form & Provide Coaching</span>
                          </li>
                          <li className="flex items-center justify-center gap-2">
                            <svg className="w-5 h-5 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                            </svg>
                            <span>Calculate Your RPE, & Time Under Tension</span>
                          </li>
                        </ul>
